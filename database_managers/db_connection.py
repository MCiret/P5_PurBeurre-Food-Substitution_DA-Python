...
try:
    ...
    if err.errno == 1045:
        print(f"Vérifier les paramètres de connexion dans le fichier config.py du projet.\n")
    elif err.errno == 1049:
        print(f"La base de données n'existe pas. Consulter le fichier README.rst, section 'Installation', étape 2. concernant la création de la base de données.\n")
    else:
        print(f"{err}")
    print("Exit...")
    exit()
