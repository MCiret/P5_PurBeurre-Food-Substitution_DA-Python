...
class SubstitutionView(FoodView):
    ...
    def explain_substitution_results(self):
        print("\n🛈 Précisions sur les résultats :\n"
              ...
              "∙ Similaire = uniquement même sous-catégorie de comparaison que l'aliment substitué (affiché(s) "
              "uniquement si aucun substitut n'a été trouvé).")
    ...
    def foods_similar_to_substituted_food(self, substituted_food: 'Food', similar_foods: ' list[Food]'):
        ...
        txt2 = ("🛈 Votre base de donnée locale ne contient peut-être pas assez de données ou "
                "l'aliment sélectionné présente un bon Nutri-Score.")
